package com.example.instagram_ari.adaptadores;
...
import com.example.instagram_ari.Publicaciones.Publicacion;
import com.example.instagram_ari.R;
...
public class AdapterPublicaciones extends RecyclerView.Adapter<AdapterPublicaciones.ViewHolder> implements View.OnClickListener  {
    ...
    int imgpublicacion;
        imgpublicacion = model.get(position).getImagenpublica();
